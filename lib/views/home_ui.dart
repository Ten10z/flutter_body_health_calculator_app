...
class _HomeUiState extends State<HomeUi> {
  ...
  //สร้างตัวแปรเก็บ Widget หน้าจอที่จะมาแสดง body ของ Scf
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFFFFB8C0),
        title: Text(
      ...
      bottomNavigationBar: BottomNavigationBar(
        onTap: (value){
          setState(() { //ใช้ตอนมีหลายตัวให้กดในหน้าเดียว
            currentIndexStatus = value;
          });
        },
        currentIndex: currentIndexStatus,
        selectedItemColor: Color(0xFFFFB8C0),
        items: [
